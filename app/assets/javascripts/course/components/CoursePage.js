...
class CoursePage extends React.Component {
  ...
  displayComponent(id) {
    const displayedComponent =
      this.state.displayedSubsection.components.find((element) => {
  ...
  displayNextComponent() {
    ...
    const index = components.indexOf(this.state.displayedComponent)
  ...
  displayNextSubsection() {
    ...
    const nextSubsection = subsections.find((element, index) => {
