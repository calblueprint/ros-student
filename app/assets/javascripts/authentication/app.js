...
render((
  <Router history={browserHistory}>
    ...
    <Route path={ReactRoutes.adminsForgotPasswordPath} name='StudentForgotPasswordPage' component={StudentForgotPasswordPage} />
    <Route path={ReactRoutes.studentsForgotPasswordPath} name='AdminForgotPasswordPage' component={AdminForgotPasswordPage} />
  </Router>
